...
export const StackSection = ({darkMode} : StackSectionProps) => {
  ...
  return (
    <section id="stack" className="background-circuit w-full py-20 bg-gradient-to-b from-gray-100 to-white dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4">
        <h2 className={`text-4xl font-extrabold text-center text-[#00bcff] mb-8`}>
          My Tech Stacks
        </h2>
      ...
      <style>{`
        .background-circuit {
          background-color: ${darkMode ? 'bg-[#030712] text-[#645c5c]' : 'bg-[#f4f4f4]'};
